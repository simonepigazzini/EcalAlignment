///===================================
///==== c++ -o EE_Alignment_RotoTraslation_singleSM.exe EE_Alignment_RotoTraslation_singleSM.cpp `root-config --cflags --glibs` -lMinuit `clhep-config --libs`
///===================================
...
int main(int argc, char** argv) {
 ...
 std::cout << " whichSC = " << whichSC << std::endl;
