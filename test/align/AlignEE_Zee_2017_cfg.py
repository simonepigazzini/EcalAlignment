...
#2017 values
  DetaBias = cms.untracked.string(" (x>0.0 && x<1.5)  * (-0.298e-3) \
                                   +(x>1.5)           * (0.271e-3)    \
                                   +(x<0.0 && x>-1.5) * (0.188e-3)    \
                                   +(x<-1.5)          * (-0.206e-3) \
                                   + y*0"),

  DphiBias = cms.untracked.string(" (y>0)*    \
                                  ((x>0.0 && x<1.5)   * (1.228e-3)  \
                                 + (x>1.5)            * (1.813e-3)  \
                                 + (x<0.0 && x>-1.5)  * (0.538e-3)  \
                                 + (x<-1.5)           * (1.842e-03)) \
                                 + (y<0)*   \
                                   ((x>0.0 && x<1.5)   * (-0.489e-03) \
                                 + (x>1.5)             * (-1.759e-03) \
                                 + (x<0.0 && x>-1.5)  * (-1.161e-03)  \
                                 + (x<-1.5)           * (-1.739e-03))"), 
