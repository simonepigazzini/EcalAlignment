...
#                                              ),
                                   ...
                                   connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
                                    ...
                                    tag = cms.string("TrackerSurfaceDeformations_v11_offline"),
                                    connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
                                                ),
                                    cms.PSet(record = cms.string("SiPixelTemplateDBObjectRcd"),
                                    tag = cms.string("SiPixelTemplateDBObject_38T_forPR26263"),
                                    connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
                                                ),
                                    cms.PSet(record = cms.string("SiPixelLorentzAngleRcd"),
                                    tag = cms.string("SiPixelLorentzAngle_38T_forPR26263"),
                                    connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
                                                ),
                                    cms.PSet(record = cms.string("SiPixelGenErrorDBObjectRcd"),
                                    tag = cms.string("SiPixelGenErrorDBObject_38T_forPR26263"),
                                    connect = cms.string("frontier://FrontierProd/CMS_CONDITIONS")
                                                ),
