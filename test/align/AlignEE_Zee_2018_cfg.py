...
process.inputTree = cms.PSet(
  ...
  #selection = cms.string("(electrons_classification==0 && ETSC>30) && ((abs(eta) <= 1.5 && (eleTrkIso + eleEcalIso + eleHcalIsoD1 + eleHcalIsoD2)/pT < 0.07 && abs(SigmaIEtaIEta)<0.01) || (abs(eta) >= 1.5 && (eleTrkIso + eleEcalIso + eleHcalIsoD1 + eleHcalIsoD2)/pT < 0.06 && abs(SigmaIEtaIEta)<0.03))"),
                             #selection = cms.string("(electrons_classification==0 && ETSC>40) && mll<95 && mll>85 && ((abs(eta) <= 1.5 && (eleTrkIso + eleEcalIso + eleHcalIsoD1 + eleHcalIsoD2)/pT < 0.07 && abs(SigmaIEtaIEta)<0.01) || (abs(eta) >= 1.5 && (eleTrkIso + eleEcalIso + eleHcalIsoD1 + eleHcalIsoD2)/pT < 0.06 && abs(SigmaIEtaIEta)<0.03))"),
...
process.outputTree = cms.PSet(
  ...
  #outputFile = cms.string("myEEAlignment_2016_NewTrkAlign_newPix_28May2016.txt")
  #outputFile = cms.string("myEEAlignment_2016_NewTrkAlign_newPix_28May2016_testWithoutRotations.txt")
  #outputFile = cms.string("myEEAlignment_2016_NewTrkAlign_newPix_28May2016_testWithoutRotations_newAlgoWithFabs.txt")
  #outputFile = cms.string("myEEAlignment_2016_NewTrkAlign_newPix_28May2016_newAlgoWithFabs.txt")
  outputFile = cms.string("myEEAlignment_2018_preliminary_onlytranslation_version_25May.txt")
)
