...
#2017 values
  DetaBias = cms.untracked.string(" (x>0.0 && x<1.5)  * (-(2.909e-3)) \
                                   +(x>1.5)           * (2.689e-3)    \
                                   +(x<0.0 && x>-1.5) * (1.806e-3)    \
                                   +(x<-1.5)          * (-(2.035e-3)) \
				   + y*0"),

  DphiBias = cms.untracked.string(" (y>0)*    \
                                  ((x>0.0 && x<1.5)   * (13.337e-03)  \
                                 + (x>1.5)            * (15.572e-03)  \
                                 + (x<0.0 && x>-1.5)  * (6.186e-03)  \
                                 + (x<-1.5)           * (16.015e-03)) \
                                 + (y<0)*   \
                                   ((x>0.0 && x<1.5)   * (-5.721e-03) \
                                 + (x>1.5)             * (-15.069e-03) \
                                 + (x<0.0 && x>-1.5)  * (-12.687e-03)  \
                                 + (x<-1.5)           * (-14.893e-03))"),     
...
process.outputTree = cms.PSet(
  ...
  outputFile = cms.string("myEEAlignment_2017_preliminary_onlytranslation.txt")
)
