...
process.source = cms.Source("PoolSource",
  # fileNames = cms.untracked.vstring('file:/data2/amassiro/CMSSWRoot/WZtoAnything_TuneZ2_7TeV-pythia6-tauola_Spring11-PU_S1_START311_V1G1-v1/F0F54048-4A50-E011-9CDE-003048D47792.root')   
   ...
   'file:/data2/amassiro/CMSSWRoot/SingleElectron_Run2011A-EcalCalElectron-v4_ALCARECO/E6B8255E-C292-E011-B6A0-003048D2C01A.root')
       )
...
#####process.myelectrontracking = cms.Sequence(
...
#####process.pReRECO = cms.Sequence(process.myelectrontracking*process.particleFlowReco*process.pfElectronTranslator*process.gsfElectronSequence)
...
# not used! (begin)
process.patMETs.addMuonCorrections = cms.bool(False)   # not available in AlCaReco
