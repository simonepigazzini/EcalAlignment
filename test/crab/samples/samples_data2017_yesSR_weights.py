...
config.JobType.psetName = '../reco_RAW2DIGI_RECO2017_yesSRatPF_weights.py'
...
config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/amassiro/16Oct/yesSRatPF_weights/'    
...
config.General.workArea     = 'crab_projects_yesSRatPF_weights'
