...
#config.General.workArea     = 'crab_projects_05Sep_fromRaw_newECAL_allData_RunB'
#config.JobType.psetName = '../reco_my_tag_RAW2DIGI_RECO_AOD.py'
#config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/amassiro/ECALAlignment/DATA05Sep2015AODRAWAllDataRunB'
#config.Data.lumiMask = "/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions15/13TeV/Cert_246908-254879_13TeV_PromptReco_Collisions15_JSON.txt"
#config.JobType.maxMemoryMB = 2500    # 2.5 GB
#config.JobType.maxJobRuntimeMin = 2800
#config.JobType.inputFiles = ['../EBAlign_2015.db','../EEAlign_2015.db', '../TkAlignment.db']
...
config.General.workArea     = 'crab_projects_05Sep_fromRaw_newECAL_lastTrk_allData_RunB'
config.JobType.psetName = '../reco_my_tag_RAW2DIGI_RECO_AOD.py'
config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/amassiro/ECALAlignment/DATA05Sep2015AODRAWAllDataRunBlastTrk'
config.Data.lumiMask = "/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions15/13TeV/Cert_246908-254879_13TeV_PromptReco_Collisions15_JSON.txt"
config.JobType.maxMemoryMB = 2500    # 2.5 GB
config.JobType.maxJobRuntimeMin = 2800
