...
config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/twamorka/UltraLegacy_NoTrackerConditions'
...
config.General.workArea     = 'crab_projects_ECAL_LegacyConditions_NoTracker'
