...
config.General.requestName = 'ZElectron-09May2018-v1'
...
config.JobType.psetName = '../reco_RAW2DIGI_RECO2019.py'
...
config.Data.inputDataset = '/DoubleEG/Run2017F-ZElectron-09May2018-v1/RAW-RECO'
...
config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/twamorka/Alignment_2018/'
