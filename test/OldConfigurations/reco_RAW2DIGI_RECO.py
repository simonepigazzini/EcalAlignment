...
# with command line options: reco -s RAW2DIGI,RECO -n 100 --filein=/store/data/Run2017F/DoubleEG/RAW-RECO/ZElectron-09May2018-v1/80005/48DF7EE7-1360-E811-985D-FA163EB82297.root --data --conditions=106X_dataRun2_trackerAlignment2017_v1 --era=Run2_2017 --runUnscheduled --nThreads=4
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('superRECO',eras.Run2_2017)
