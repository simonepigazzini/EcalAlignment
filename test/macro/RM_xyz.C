...
int getAnglesCLHEP( std::vector<std::vector<double> > RM33, double angle1[3], double angle2[3], bool printInfo=true )
{
 ...
 if( printInfo )
 {
  ...
  printf(" Sol 1. mrad ( phi, theta, psi ) = ( %11.8f   %11.8f    %11.8f )\n", angle1[0]*1000, angle1[1]*1000, angle1[2]*1000);
  printf(" Sol 2. mrad ( phi, theta, psi ) = ( %11.8f   %11.8f    %11.8f )\n", angle2[0]*1000, angle2[1]*1000, angle2[2]*1000);
 }
