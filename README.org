...
cmsrel CMSSW_12_0_0 <The CMSSW version will change depending on when alignment is being performed>
cd CMSSW_12_0_0/src/
mkdir EcalValidation
cd EcalValidation
git clone -b CMSSW_12_0_0 git@github.com:NEUAnalyses/EcalAlignment.git
