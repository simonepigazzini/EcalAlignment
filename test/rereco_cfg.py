...
# with command line options: reco -s RAW2DIGI,L1Reco,RECO,PAT --conditions auto:run3_data_prompt --data --era Run3 --python_filename=rereco_cfg.py --filein=/store/data/Run2022C/EGamma/MINIAOD/PromptReco-v1/000/355/869/00000/6f9ce205-d2bd-4662-b961-6804defdf3f7.root
...
process.source = cms.Source("PoolSource",
    #fileNames = cms.untracked.vstring('/store/data/Run2022C/EGamma/MINIAOD/PromptReco-v1/000/355/869/00000/6f9ce205-d2bd-4662-b961-6804defdf3f7.root'),
