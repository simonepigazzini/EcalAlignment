...
void drawSingleModule(TString nameInFileRoot, TString nameOutputDir, TString commonCut = "1", int iEB=-100, int iEE=-100, int isMC=1, TString nameInFileRootComparison = "", int specialRegions = 0, int specialZeroTesla = 0){
 TDRStyle();
